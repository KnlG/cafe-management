    ...
    public ResponseEntity<String> generateReport(Map<String, Object> requestMap) {
        ...
        try{
            ...
            if(validateRequestMap(requestMap)){
                ...
                Paragraph chunk = new Paragraph("Cafe Java Management System", getFont("Header"));
                ...
                for(int i=0; i<jsonArray.size(); i++){
                    addRow(table, CafeUtils.getMapFromJson(jsonArray.get(i)));
                }
                document.add(table);
                Paragraph footer = new Paragraph("Total: "+ requestMap.get("total")+"\n"+
                        "Thanks for your visit!", getFont("Data"));
                document.add(footer);
                document.close();
    ...
    public ResponseEntity<String> deleteBill(Integer id) {
        try{
            ...
            if(optional.isPresent()){
                ...
                return CafeUtils.getResponseEntity("Bill with this id doesn't exist.", HttpStatus.OK);
            }
        }catch(Exception exception){
            exception.printStackTrace();
        }
